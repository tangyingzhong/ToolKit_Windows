	...
	EncodeType eEncodeType)
{
	...
	if (eEncodeType==ENCODE_UTF8)
	{
		...
		std::string strUtf8 = UTF8::GetString(strUnicode, eEncodeType);
...
ANSI::StdString ANSI::GetString(WStdString UnicodeString, EncodeType eEncodeType)
{
	...
	if (eEncodeType==ENCODE_UTF8)
	{
		std::string strUtf8 = UTF8::GetString(UnicodeString, eEncodeType);

		std::string strAnsi = UTF8ToANSI(strUtf8);
