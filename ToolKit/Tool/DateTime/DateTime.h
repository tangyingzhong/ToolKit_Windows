...
namespace System
{
	namespace Clock
	{
		...
		public:
			...
			static DateTime FromString(String strTime, String strTimeFormat = String("yyyy-MM-dd hh:mm:ss"));

			// Convert time to string with sepecial seperator
			String ToString(String strTimeFormat = String("yyyy-MM-dd hh:mm:ss"));
